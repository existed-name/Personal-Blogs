...
![](/assets/images/问题排查/解决WindowsXP忘记密码/01-DownloadWepe.png "")  
...
![](/assets/images/问题排查/解决WindowsXP忘记密码/02-DownloadToUDist.png "")  

然后设置属性(备注: `卷标` = 这个U盘的名字)
![](/assets/images/问题排查/解决WindowsXP忘记密码/03-InstallSettings.png "")  
![](/assets/images/问题排查/解决WindowsXP忘记密码/04-InstallSettingsExplanation.png "")  
![](/assets/images/问题排查/解决WindowsXP忘记密码/05-FinishInstall.png "")  
...
![](/assets/images/问题排查/解决WindowsXP忘记密码/06-DiskManagement.png "")  
![](/assets/images/问题排查/解决WindowsXP忘记密码/07-DiskPartition.png "")  
...
![](/assets/images/问题排查/解决WindowsXP忘记密码/08-DownloadNtpwedit.png "")  
...
![](/assets/images/问题排查/解决WindowsXP忘记密码/09-BIOS.png "")  
...
![](/assets/images/问题排查/解决WindowsXP忘记密码/10-Advanced.png "")  
...
![](/assets/images/问题排查/解决WindowsXP忘记密码/11-Boot.png "")  
...
### (2)改密码
1. 此时应该在加载微PE系统了
![](/assets/images/问题排查/解决WindowsXP忘记密码/12-Loading1.png "")  
![](/assets/images/问题排查/解决WindowsXP忘记密码/13-Loading2.png "")  
![](/assets/images/问题排查/解决WindowsXP忘记密码/14-HomePage.png "")  
...
* 也可以直接文件资源管理器进去打开程序
![](/assets/images/问题排查/解决WindowsXP忘记密码/15-StartNtpwedit.png "")  
...
![](/assets/images/问题排查/解决WindowsXP忘记密码/16-ChangePassword.png "")  
![](/assets/images/问题排查/解决WindowsXP忘记密码/17-NewPassword.png "")  
...
### (1)
我最开始试的F8进入高级选项
![](/assets/images/问题排查/解决WindowsXP忘记密码/18-F8.png "")  
* `安全模式`: 也要密码
...
![](/assets/images/问题排查/解决WindowsXP忘记密码/19-Menu1.png "")  
![](/assets/images/问题排查/解决WindowsXP忘记密码/20-Menu2.png "")  
![](/assets/images/问题排查/解决WindowsXP忘记密码/21-Menu3.png "")  
...
![](/assets/images/问题排查/解决WindowsXP忘记密码/22-Continue.png "")  
![](/assets/images/问题排查/解决WindowsXP忘记密码/23-Dism++.png "")  

* 选择C盘 → `打开会话` → 它说`不支持此接口`😓
![](/assets/images/问题排查/解决WindowsXP忘记密码/24-Click.png "")  
