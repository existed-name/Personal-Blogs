...
![图标对比](/assets/images/问题排查/解决IDEA-Maven项目显示异常问题/01-IconComparison.png "图标对比")  

③这个项目里面的编译器**检测功能失效**，不能检查语法错误、警告/提醒，但其他项目可以正常检测
![取消语法高亮和自动检测](/assets/images/问题排查/解决IDEA-Maven项目显示异常问题/02-NoHighlighting.png "取消语法高亮和自动检测")  
![有语法高亮和自动检测](/assets/images/问题排查/解决IDEA-Maven项目显示异常问题/03-Highlighting.png "有语法高亮和自动检测")  
...
![添加为Maven项目](/assets/images/问题排查/解决IDEA-Maven项目显示异常问题/04-AddAsMavenProject.png "添加为Maven项目")  

* Gemini给的方法挺有用的  
![拿下~](/assets/images/问题排查/解决IDEA-Maven项目显示异常问题/05-Solutions.png "拿下~")  
