...
```
![配置展示](/assets/images/技术教程类/MyBatis配置xml模板/01-Settings.png "配置展示")  

### （2）创建文件
选择1个文件(夹) → 右键后点击`New`(也可以直接`Alt + Shift + Insert`) → `MyBatis Mapper`  
![创建文件](/assets/images/技术教程类/MyBatis配置xml模板/02-NewFile.png "创建文件")  

甚至命名空间都自动生成了  
![自动化~~~](/assets/images/技术教程类/MyBatis配置xml模板/03-AutoTemplate.png "自动化~~~")  
