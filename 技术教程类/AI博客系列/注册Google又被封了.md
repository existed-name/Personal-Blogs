...
![你的国家不支持](/assets/images/技术教程类/AI博客系列/注册Google又被封了/01-GeminiNotSupport.png "你的国家不支持")  
...
![电脑网页端注册](/assets/images/技术教程类/AI博客系列/注册Google又被封了/02-CreateAccount.png "电脑网页端注册")  
![手机扫码](/assets/images/技术教程类/AI博客系列/注册Google又被封了/03-ScanQRCode.png "手机扫码")  

然后Google会在手机上读取验证设备信息，结果他说我的手机号用了太多次了，让换个手机号（重试一下还是这样）
![换号码](/assets/images/技术教程类/AI博客系列/注册Google又被封了/04-TryDifferentPhoneNumber.png "换号码")  


### (2)电脑端+别的手机号
结果扫码、进入链接后，它让我给它发短信——然而发送失败  
![短信发送失败](/assets/images/技术教程类/AI博客系列/注册Google又被封了/05-FailToSendMsg.png "短信发送失败")  
...
![安全性设置](/assets/images/技术教程类/AI博客系列/注册Google又被封了/06-SecuritySettings.png "安全性设置")  
...
![2步验证](/assets/images/技术教程类/AI博客系列/注册Google又被封了/07-TwoStepVarify.png "2步验证")  
...
![设置验证器](/assets/images/技术教程类/AI博客系列/注册Google又被封了/08-SetupAuthenticator.png "设置验证器")  
...
![手机验证码](/assets/images/技术教程类/AI博客系列/注册Google又被封了/09-VerifyPhoneNumber.png "手机验证码")  



## 5、申诉
我以为没事了，后来发现创建账号后3个小时，就被封了
![封号斗罗](/assets/images/技术教程类/AI博客系列/注册Google又被封了/10-Disabled.png "封号斗罗")  
...
> <u>[解决Gemini异常：SomethingWentWrong](/问题排查/AI服务与风控/Gemini/解决Gemini异常：SomethingWentWrong.md)</u>  
